"""
HTML parser
This is from tkhtmlview package (https://github.com/bauripalash/tkhtmlview)
Due to a typo, the PyPI package cannot be used as is, so using the corrected file temporarily.
"""
import os
import webbrowser
